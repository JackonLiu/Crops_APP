...
public class baike1 extends Activity implements OnItemClickListener,View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baike1);
        abc();
        ...
        ArrayAdapter<String>adapter=new ArrayAdapter<String>(baike1.this,android.R.layout.simple_expandable_list_item_1,res);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        baike1.this.startActivity(intent);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imageButton4:
                dataList.clear();
                simpleAdapter=new SimpleAdapter(baike1.this,dataList,R.layout.item,new String[]{"imageView","textView","imageView1"},new int[]{R.id.imageView,R.id.imageView11,R.id.imageView12});
                listView.setAdapter(simpleAdapter);
            ...
            case R.id.imageButton5:
                Intent intent88=new Intent(baike1.this,CameraActivity.class);
