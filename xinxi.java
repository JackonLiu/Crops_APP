...
public class xinxi extends Activity implements OnItemClickListener,View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.imageButton4:
                dataList.clear();
                simpleAdapter=new SimpleAdapter(xinxi.this,dataList,R.layout.item,new String[]{"imageView","textView","imageView1"},new int[]{R.id.imageView,R.id.imageView11,R.id.imageView12});
                listView.setAdapter(simpleAdapter);
            ...
            case R.id.imageButton5:
                Intent intent88=new Intent(xinxi.this,CameraActivity.class);
